...
<body>
    ...
    <script type="text/javascript">
        ...
        s1.async=true;
        s1.src='https://embed.tawk.to/65c6a9788d261e1b5f5e718c/1hm80c093';
        s1.charset='UTF-8';
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-2">
                            <div class="navbar-header">
                                <a class="navbar-brand" href="{{route('index')}}"><img src="{{asset('frontend')}}/assets/images/logo.svg"
                                        alt="logo"></a>
                            </div>
                        </div>
                            ...
                            <div action="#" class="middle-box">
                                ...
                                <div class="search-box">
                                    <div class="input-group">
                                        <input type="search" value="" id="search_input" class="form-control" placeholder="What are you looking for ?">
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="middle-right">
                                <ul>
                                    ...
                                    @auth('customer')
                                    <li><a href="{{route('customer.profile')}}"><i class="fi flaticon-user-profile"></i><span>{{Auth::guard('customer')->user()->fname.' '.Auth::guard('customer')->user()->lname}}</span></a></li>
                                    @else
                                        ...
                                        <div class="mini-cart">
                                            ...
                                            <div class="mini-cart-content">
                                                ...
                                                <div class="mini-cart-items">
                                                    ...
                                                    <div class="mini-cart-item clearfix">
                                                        <div class="mini-cart-item-image">
                                                            <a href="product.html"><img src="{{asset('uploads/product/preview')}}/{{$cart->rel_to_product->preview_image}}" alt></a>
                                                        </div>
                                                        <div class="mini-cart-item-des">
