...
@section('content')
                    ...
                    <div class="featured-item">
                        ...
                        <div class="text">
                            <h2>
                                ...
                                <a href="product.html">{{substr($category->category_name, 0, 15).'..'}}</a>
                                @else
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12">
                        <div class="offer-wrap" style=" background: url({{asset('uploads/offer')}}/{{$offer1->first()->photo}});">
                            <div class="content">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="banner-two-wrap" style=" background: url({{asset('uploads/offer')}}/{{$offer2->first()->photo}});">
                            <div class="text">
        ...
        <section class="themart-trendingproduct-section section-padding">
            <div class="container">
                ...
                <div class="trendin-slider owl-carousel">
                    ...
                    <div class="product-item">
                        <div class="image">
                            <img height="250" src="{{asset('uploads/product/preview')}}/{{$product->preview_image}}" alt="">
                            @if ($product->discount)
                            <div class="tag sale">-{{$product->discount}}%</div>
                            @else
                            <div class="tag new">New</div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="highlight-wrap">
                            ...
                            <div class="product-card">
                                <div class="card-image">
                                    <div class="image">
                                        <img width="120" src="{{asset('uploads/product/preview')}}/{{$product->preview_image}}" alt="">
                                    </div>
                                </div>
                                <div class="content">
        ...
        <section id="sub" class="themart-cta-section section-padding">
            <div class="container">
                <div class="cta-wrap">
                    <div class="row">
