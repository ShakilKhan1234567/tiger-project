...
class CheckoutController extends Controller
{
    ...
    function order_store(Request $request){
        ...
        if($request->payment_method == 1){
            $order_id = '#'.uniqid().' - '.Carbon::now()->format('m-d-Y');
            Order::insert([
              'order_id'=>$order_id,
            ...
            foreach($carts as $cart){
                ...
                $api_key = "TJtPADAH2YzdYKIPVpWl";
                $senderid = "8809617615400";
                $number = $request->phone;
                $message = "Congratulation Your Order has been placed. Please ready amount: $to_tal taka";
